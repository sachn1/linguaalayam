...
The web UI at [linguaalayam.org](https://linguaalayam.org) supports English and Malayalam interface languages, ISO 15919 romanised output alongside Malayalam definitions (toggle with the **A ↔ അ** button), and intent-based corpus selection.
